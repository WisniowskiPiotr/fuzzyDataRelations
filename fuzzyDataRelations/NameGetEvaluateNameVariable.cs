...
namespace fuzzyDataRelations
{
    ...
    /// </summary>
    public class NameGetEvaluateNameVariable
    {
        ...
        /// Default constructor.
        /// </summary>
        public NameGetEvaluateNameVariable()
        {
        }

        /// <param name="name">The name that identificates the membership function.</param>
        public NameGetEvaluateNameVariable(string name)
        {
            this.Name = name;
        }
        ...
        public NameGetEvaluateNameVariable(string name, double x0, double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = x0;
            this.X1 = x1;
