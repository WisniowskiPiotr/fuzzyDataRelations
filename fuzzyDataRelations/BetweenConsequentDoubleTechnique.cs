...
namespace fuzzyDataRelations
{
    ...
    /// </summary>
    public class BetweenConsequentDoubleTechnique
    {
        ...
        /// Default constructor.
        /// </summary>
        public BetweenConsequentDoubleTechnique()
        {
        }

        /// <param name="name">The name that identificates the membership function.</param>
        public BetweenConsequentDoubleTechnique(string name)
        {
            this.Name = name;
        }
        ...
        public BetweenConsequentDoubleTechnique(string name, double x0, double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = x0;
            this.X1 = x1;
