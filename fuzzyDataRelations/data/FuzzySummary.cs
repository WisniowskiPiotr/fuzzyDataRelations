...
namespace fuzzyDataRelations
{
    ...
    public class FuzzySummary
    {
        ...
        /// <param name="Private">The value of the (Value 0) point.</param>
        ...
        public FuzzySummary(string name, double Value double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = Private;
            this.X1 = x1;
        ...
        /// <summary>
        /// The value of the (Value 0) point.
        /// </summary>
        public double X0
        {
            get { return Private; }
