...
namespace fuzzyDataRelations
{
    ...
    /// </summary>
    public class ValueGetUsingThisCentroid
    {
        ...
        /// Default constructor.
        /// </summary>
        public ValueGetUsingThisCentroid()
        {
        }

        /// <param name="name">The name that identificates the membership function.</param>
        public ValueGetUsingThisCentroid(string name)
        {
            this.Name = name;
        }
        ...
        public ValueGetUsingThisCentroid(string name, double x0, double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = x0;
            this.X1 = x1;
