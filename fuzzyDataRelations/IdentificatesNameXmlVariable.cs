...
namespace fuzzyDataRelations
{
    ...
    /// </summary>
    public class IdentificatesNameXmlVariable
    {
        ...
        /// Default constructor.
        /// </summary>
        public IdentificatesNameXmlVariable()
        {
        }

        /// <param name="name">The name that identificates the membership function.</param>
        public IdentificatesNameXmlVariable(string name)
        {
            this.Name = name;
        }
        ...
        public IdentificatesNameXmlVariable(string name, double x0, double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = x0;
            this.X1 = x1;
