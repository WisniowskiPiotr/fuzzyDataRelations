...
namespace fuzzyDataRelations
{
    ...
    /// </summary>
    public class PublicStringEndregion
    {
        ...
        public PublicStringEndregion(string name, double x0, double x1, double x2, double x3)
        {
            this.Name = name;
            this.X0 = x0;
            this.X1 = x1;
